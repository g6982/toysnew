...

{
    ...
    "author": "BrowseInfo",
    'summary': 'point of sale reprint and reorder reprint POS Order list pos reorder pos repeat order pos order repeat point of sales reorders pos re-orders pos orders pos list orders pos reprint pos order reprint pos order reprint pos order receipt reprint pos receipt',
    "description": """
