odoo.define('aspl_pos_close_session.CloseCashControlScreen', function (require) {
    ...
    class CloseCashControlScreen extends IndependentToOrderScreen {
        async _rpc_other_paids(){
             rpc.query({
                model: "pos.session",
                method: "all_other_paids",
                args: [this.props.sessionData[0]],
        ...
        constructor() {
            ...
            this.payments = JSON.parse(this.props.sessionData[0].info_amounts);
            ...
            this.state = useState({ closeInputLines:this._generate_lines_cash(), closeTotal:0,
                                    showCloseStaticLines : false,
