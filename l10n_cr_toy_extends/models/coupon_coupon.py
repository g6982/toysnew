...
class Coupon(models.Model):
    ...
    pos_order_id = fields.Many2one('pos.order', 'Orden POS referencial', readonly=True,
        help="The sales order from which coupon is generated")
    pos_sales_order_id = fields.Many2one('pos.order', 'Used in', readonly=True,
        help="The sales order on which the coupon is applied")

    def _check_coupon_code_pos(self, order):
        message = {}
        ...
        elif self.program_id.program_type == 'coupon_program' and not self.program_id._filter_on_mimimum_amount_pos(order):
            message = {'error': _(
        ...
        elif self.program_id.reward_type == 'product' and not order._is_reward_in_order_lines_pos(self.program_id):
        ...
        elif self.program_id.program_type == 'coupon_program' and not self.program_id._filter_programs_on_products_pos(order):
